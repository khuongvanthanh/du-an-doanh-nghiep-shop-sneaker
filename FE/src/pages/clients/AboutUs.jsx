      ...
      <Grid container spacing={2}>
        <Grid xs={12} md={6}>
          ...
          <Typography level="body1" gutterBottom>
            Được thành lập vào năm 2023, Snaker đã nhanh chóng vươn lên trở
          ...
          <Typography level="body1" gutterBottom>
            Tại Snaker, chúng tôi tin tưởng vào sức mạnh của công nghệ và dữ
            liệu. Đội ngũ của chúng tôi, Tôi từ FPT Polytechnic, đã dành
          ...
          <Typography level="body1" gutterBottom>
            Với hơn 1 triệu sản phẩm đa dạng trong danh mục của mình, Snaker
            chuyên cung cấp giày chất lượng cao với nhiều mẫu mã, màu sắc và
          ...
          <Typography level="body1" gutterBottom>
            ...
            phẩm tốt nhất cho khách hàng. Snaker không chỉ là một thương
            hiệu; nó là biểu tượng của sự sáng tạo và niềm đam mê với thời
            trang. Hãy cùng chúng tôi khám phá thế giới giày đầy màu sắc và
            phong cách!
          </Typography>
          <Typography level="h3" fontWeight="bold" gutterBottom>
            Giới Thiệu Về Snaker
          </Typography>
          <Typography level="body1" gutterBottom>
            Tại Snaker, chúng tôi không chỉ bán giày; chúng tôi tạo ra
            những câu chuyện. Mỗi chiếc giày mà chúng tôi cung cấp đều mang
          ...
          <Typography level="body1" gutterBottom>
            ...
            người đều xứng đáng có được một chiếc giày phù hợp với cá tính
            và phong cách sống của mình. Snaker cam kết lắng nghe ý kiến và
          ...
          <Typography level="body1" gutterBottom>
            Snaker hướng tới việc trở thành thương hiệu giày hàng đầu tại
          ...
          <Typography level="body1" gutterBottom>
            ...
            tạo ra những chiếc giày không chỉ đẹp mà còn bền đẹp qua thời
            gian.
          </Typography>
          <Typography level="h3" fontWeight="bold" gutterBottom>
          ...
          <Typography level="body1" gutterBottom>
            Tại Snaker, chúng tôi tin rằng sức mạnh của một thương hiệu không
      ...
      <Grid container spacing={4}>
        <Grid xs={12} md={4}>
          <Card variant="outlined" sx={{ boxShadow: 2 }}>
            ...
            >
              <Avatar
                src="https://res.cloudinary.com/dp0odec5s/image/upload/v1731337073/wyv5jqhzomkcgvejbjnl.jpg"
                alt="Founder"
                sx={{
                  width: 120,
                  height: 120,

        ...
        <Grid xs={3}>
          <Card variant="plain" color="neutral" invertedColors>
            <CardContent orientation="horizontal">
              ...
              <CardContent>
                <Typography level="body-md">Tổng Giày Đã Bán</Typography>
        ...
        <Grid xs={6}>
          ...
          <PieChart
            series={[
              {
                data: [
                  { id: 0, value: 35, label: "Nike" },
                  { id: 1, value: 25, label: "Adidas" },
                  { id: 2, value: 20, label: "Puma" },
                  { id: 3, value: 10, label: "Reebok" },
                  { id: 4, value: 10, label: "Under Armour" },
                ],
              },
            ]}
            width={500}
